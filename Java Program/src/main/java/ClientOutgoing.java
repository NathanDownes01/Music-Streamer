...
public class ClientOutgoing {
    ...
    private final String serverIp = "Change this text to server ip";
    ...
    //sends server request to play song
    ...
    //sends server request to skip to certain part of song
    public void skipToPart(int part){
        String instruction = "SKIP" +part;
        System.out.println("----------------"+instruction+"-------------------");
        try{
            output.write(instruction.getBytes(),0,instruction.length());
            output.flush();
    ...
    public float getMaxVol(){
        return music.getMaxVol();
    }
    public float getMinVol(){
        return music.getMinVol();
    }
    public float getCurrentVol(){
        return music.getCurrentVol();
    }
    public void setVoume(int level){
        music.setVolume(level);
    }


    //set duration on slider
    public void setDuration(String dur){
        ControlsBar.setMaxDuration(Integer.parseInt(dur));
    }
